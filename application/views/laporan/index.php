...
<html lang="en">
    ...
    <div class="space"></div>
            <div class="row" style="padding-left: 5px;">
                <div class="col-lg-8">
                        <center>
                            <img src="assets/images/logo/poltek.jpg" style="width: 70px; height: 70px;" align="left"> 
                            <img src="assets/images/logo/ukmb.jpeg" style="width: 110px; height: 70px;" align="right">
                    ...
                    <b style="font-size: 10px;"> <?= $subtitle; ?></b><br>
                     <table style="font-size: 10px;" id="tabel" class="table table-hover table-bordered table-striped table-Condensed">
                            ...
                            <?php $i = 1; ?>  
                            <?php foreach ($dataFilter as $masuk) : ?>
                            <tr>
                                <td><?= $i++; ?></td>
