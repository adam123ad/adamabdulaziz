                    ...
                    <div class="page-content">
                      <div class="ace-settings-container" id="ace-settings-container">
                        ...
                        <div id="user-profile-1" class="user-profile row">
                                  ...
                                  <!-- Image -->
                                    <span class="profile-picture">
                                      <ul class="ace-thumbnails clearfix"> 
                                        <li>
                                          <a href="<?= base_url('assets/images/suratmasuk/').$detailSM['image']; ?>" title="<?= $detailSM['no_surat']; ?>" data-rel="colorbox">
                                          <img width="100%" height="100%" alt="150x150" src="<?= base_url('assets/images/suratmasuk/').$detailSM['image']; ?>" />
                                           <div class="text">
                                          ...
                                          <div class="tags">
                                            <span class="label-holder">
                                              <a href="<?= base_url('admin/download/').$getid['id']; ?>">
                                    ...
                                    <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                        <div class="inline position-relative">
                                            <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                                                ...
                                                &nbsp;
                                                <span class="white"><b>last update :</b> <?= $detailSM['timestamp']; ?></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['no_surat']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['tgl_surat']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Tanggal Diterima </div>

                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['tgl_diterima']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['perihal']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['sifat']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['lampiran']; ?></span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                        ...
                                        <div class="profile-info-value">
                                            <span class="editable"><?= $detailSM['instansi']; ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <a href="" class="btn btn-warning" style="margin-bottom: 15px;" data-toggle="modal" data-target="#editSuratMasuk<?= $getid['id']; ?>">Edit Data</a>&nbsp;&nbsp;&nbsp;
